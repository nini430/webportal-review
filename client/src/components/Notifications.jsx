...
const Notifications = ({setShowNots}) => {
    ...
    const handleClickOutside=(e)=>{
        if(notifRef.current&&(!e.target.contains(notifRef.current)&&!e.target.contains(document.getElementById("notification")))) {
            setShowNots(false)
        }
    }
  ...
  return (
    <div ref={notifRef} className='position-absolute  notify d-flex flex-column'>
    <div>
